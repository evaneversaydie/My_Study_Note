...
期初在驗又與紀錄怎麼裝git、github、markdown時，感覺像是從新開始學一樣，從一開始不會用github、沒有寫過markdown到現在可以用github記錄這學期的點點滴滴，真的進步很多。
這學期也發現了很多github上的資源，像是文字探勘套件CKIP的官方說明文件、平常練習爬蟲時，github上其他python分享的經驗或API。

<br>剛開始從頭摸索，看到很多平常不會用的語法時，總會覺得怎麼那麼多看不懂的事情，也會懷疑自己，但經過這學期的訓練後，會發現「要相信這些是可能的」，勇敢踏出這一步去學吧!
<br>
