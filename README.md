...
- [資料結構與演算法筆記:](#資料結構與演算法筆記)
  ...
  - [Week_4:10/10停課](#week_41010停課)
  - [Week_5: Quicks_Sort](#week_5-quicks_sort)
  - [Week_6: heap_sort](#week_6-heap_sort)
  - [Week_7: marage_sort](#week_7-marage_sort)
  - [Week_8: Binary Tree](#week_8-binary-tree)
  ...
  - [Week_14:Minimum Spanning Tree](#week_14minimum-spanning-tree)
  - [Week_15:Shortest Path](#week_15shortest-path)
  - [Week_16:期末複習](#week_16期末複習)
  - [Week_17:期末考](#week_17期末考)
  - [Week_18:停課-返鄉投票](#week_18停課-返鄉投票)
- [自我學習](#自我學習)
...
* 目前就讀: 東吳大學 巨量資料管理學系
* 常用程式語言：Python、R
* 目標: 學好程式語言，以解決問題。了解資料結構與演算法，進一步思考應用。
* Email: eva608770@gmail.com
* 歡迎您來到我的「資料結構與演算法」學習筆記! 這邊主要紀錄一些練習的程式碼與筆記。有任何需要改進的地方都歡迎與我聯繫!
...
## [Week_1: github,markdown,linked_list](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week1_Linked%20list)
*  [這學期git與寫markdown的筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week1_Linked%20list/%E6%8E%A5%E8%A7%B8github-%E4%BD%BF%E7%94%A8%E5%BF%83%E5%BE%97%2B%E8%A3%9Dgit%2B%E5%AF%ABmarkdown.md)
* [Linked list 筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week1_Linked%20list/Week1_Linked%20list.md)
...
## [Week_3: Insertion Sort](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week3_InsertionSort)

*  [Insertion Sort 筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week3_InsertionSort/readme.md)
...
## Week_4:10/10停課
10/10連假停課。
## [Week_5: Quicks_Sort](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week4_QuickSort)
學習Quick Sort
* [QuickSort 筆記](hhttps://github.com/evaneversaydie/My_Study_Note/blob/master/Week4_QuickSort/readme.md)
...
## [Week_7: marage_sort](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week6_MergeSort)
* [marage_sort 筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week6_MergeSort/readme.md)
...
## [Week_8: Binary Tree](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week8_Binary%20Tree)
...
## [Week_10: Red Black Tree](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week10_Red_BLack_Tree)
* [紅黑樹筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week10_Red_BLack_Tree/Readme.md)
...
## [Week_12:Breadth-First Search](https://github.com/evaneversaydie/My_Study_Note/tree/master/Week12_BFS)
* [BFS、DFS筆記](https://github.com/evaneversaydie/My_Study_Note/blob/master/Week12_BFS/readme.md)
...
# 自我學習
## [Codesignal](https://github.com/evaneversaydie/My_Study_Note/tree/master/Codesignal)
### About this Note:
這是我用`python3`解[codesignal](https://app.codesignal.com/)的練習程式碼與學習歷程。

### 練習題目
所有`筆記`與`程式碼`在[Codesignal2的Readme](https://github.com/evaneversaydie/My_Study_Note/blob/master/Codesignal/readme.md)中:
...
|04|[ipnb](https://github.com/evaneversaydie/My_Study_Note/blob/master/Codesignal/Arcade_04.ipynb)|code直接寫在[筆記]((https://github.com/evaneversaydie/My_Study_Note/blob/master/Codesignal/readme.md))囉|
...
# 其他學習成果
[寵物領養資料分析網站](http://myweb.scu.edu.tw/~06170235/)

# 平常額外學習的網站與工具
- [visualgo.net:把資料結構與演算法圖像化!!](https://visualgo.net/en)
* [均一教學平台](https://www.junyiacademy.org/computing/algorithm)
* [演算法筆記](http://www.csie.ntnu.edu.tw/~u91029/)
- Youtube 相關影片
* draw.io:超好用的流程圖繪製工具
* Hackmd:筆記好幫手!
* Pycharm:可以看jupyter notebook、debug mode，學生版很佛很好用
* jupyter lab:jupyter notebook的另外實用功能。

# 未來會繼續更新或是想到可以放入的內容
  * 演算法筆記
  * 更多自學筆記，如:CS50、leetcode、GitHub_Git使用札記(目前放在week1)
  * Python語法複習(目前寫在codesignal裡面)
  * 覺得好用的方法


# 期末心得
資料結構與演算法課程，幾乎是整個學期花最多時間以及跨出原本圈圈的課了!
期初在實作與紀錄怎麼裝git、github、markdown時，感覺像是從新開始學一樣，從一開始不會用github、沒有寫過markdown到現在可以用github記錄這學期的點點滴滴，真的進步很多。這學期也發現了很多github上的資源，像是文字探勘套件CKIP的官方說明文件、平常練習爬蟲時，github上其他python分享的經驗或API。以及很多網路上的教學文章，這溪都是之前不太會去看的內容。
<br>剛開始從頭摸索，看到很多平常不會用的語法時，一開始對def還很不熟。總會覺得怎麼那麼多看不懂的事情，markdown也花了很多時間才熟練，沒想到現在可以完成很多的筆記。也意外發現了很多的工具。寫作業時也會很崩潰很懷疑自己，很多次熬夜寫功課到凌晨，花了三四十個小時，一邊想著自己真的可以寫出來嗎?(一開始的作業真的常常跟老師一開學、分析班上填寫的表單實說的「抱著電腦看到天已經亮了」的感覺，還會想天亮了我的code的進展呢?)。但經過這學期的訓練後，到期末會發現之前不熟的class、def等等都變的熟悉‧。曾經期初的難題變得沒那麼難了。從leetcode、Codesignal到作業與CS50，很高興自己完成了。所以「要相信這些是可能的」，只要勇敢踏出這一步去做就好了。

<br>
最後，列出印象深刻的事情與老師的提醒班上的觀念，希望之後也不會忘記，懷來翻時也可以受益良多:
 * 不要畫地自限，你可以的!
 * 要相信性格心理學的自我效能啊啊啊!
 * 先了解邏輯再去書寫程式碼。才能了解自己正在做什麼、避免「程式運作了但不知道為什麼可以運作」‧。
 * 切記`「技術債」`。
 * 把學會的東西、做過的東西都成鋪墊的、可以使用工具。可以花更多時間在新學的事情上。像是:寫了Stack和Queque的class，BFS、DFS可以直接引用。
 * 動手做出來與憑空思考之間有一大段距離:即使課堂上畫出流程圖，在實作時也往往遇到困難。
 * 找到可以學習的資源，這些資源比想像的還多:「每個人不論在哪裡，都可以利用這些資願自己去學」。老師推薦leetcode、codesignal、CS50都是網路上的學習資源。要多多去探索。
 * 保持學習的習慣，建立學習的模式:每天都去思考作業怎麼寫，比起花一整天來的好多了。思路也會比較有彈性。保持每天學固定自習的時段是一件很重要的事情。
 * 擅用工具: python 是動態語言，相比C等等對於語法的complier容錯率很大。在寫`HW3`時，發現使用Debug Mode去了解程式如何運行、邏輯上出了什麼錯誤與寫很多個print相比是更快更有效率的方式。
 * 去嘗試外文的網站、非python 教學文，往往比平常查看的中文文章有更多驚喜。
 * 列出學習的軌跡，才能更清楚自己學了什麼、學到哪裡，也方便之後的查詢修改。
 * 學術倫理:參考任何網站都需要留下refernce，包含自我引用。

這學期結束的好快~最後，謝謝助教與老師!!!2020新年快樂!!
希望之前仍可以持續學習，調整學習的步調，努力加油!!!
