...
# 期末心得
資料結構與演算法課程，幾乎是整個學期花最多時間以及跨出原本舒適圈最多的課了!
期初在驗又與紀錄怎麼裝git、github、markdown時，感覺像是從新開始學一樣，從一開始不會用github、沒有寫過markdown到現在可以用github記錄這學期的點點滴滴，真的進步很多。這學期也發現了很多github上的資源，像是文字探勘套件CKIP的官方說明文件、平常練習爬蟲時，github上其他python分享的經驗或API。以及很多網路上的教學文章，這溪都是之前不太會去看的內容。
<br>剛開始從頭摸索，看到很多平常不會用的語法時，一開始對def還很不熟。總會覺得怎麼那麼多看不懂的事情，markdown也花了很多時間才熟練，沒想到現在可以完成。寫作業實也會懷疑自己，很多次熬夜寫功課到凌晨，一邊想著自己真的可以寫出來嗎?debug mode等等的功能之前從來沒有用過。但經過這學期的訓練後，到期末會發現之前不熟的class、def等等都變的熟悉‧「要相信這些是可能的」，只要勇敢踏出這一步去做就好了。

<br>
最後，列出印象深刻的事情與老師的提醒般上的觀念:
 * 不要畫地自限，你可以的!
  * 要相信性格心理學的自我效能啊啊啊!
